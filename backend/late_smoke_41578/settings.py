"""
Django settings for late_smoke_41578 project.
...
ROOT_URLCONF = 'late_smoke_41578.urls'
...
WSGI_APPLICATION = 'late_smoke_41578.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_smoke_41578 API",
    "DESCRIPTION": "API documentation for late_smoke_41578 App",
    "VERSION": "v1",
}
